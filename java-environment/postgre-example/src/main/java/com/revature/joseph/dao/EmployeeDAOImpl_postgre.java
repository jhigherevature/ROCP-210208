...
public class EmployeeDAOImpl_postgre implements EmployeeDAO {
	...
	public List<Employee> selectAllEmployees() {
		...
		try (Connection conn = ConnectionUtility.getConnection()) {
			...
			/*
			 * rs.next() will return true if there is still information
			 * from our result set we have not looked through. Each time
			 * next() is called, it will look at the 'next' piece of information
			 * inside of our collection of data.
			 */
			while (rs.next()) {
